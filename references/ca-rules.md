...
## 二、义务主体与义务清单（SB 1000 生效版）

> 术语译法以 `references/glossary.md` 为准。以下条文均据 SB 1000 Enrolled 逐字原文转述。
