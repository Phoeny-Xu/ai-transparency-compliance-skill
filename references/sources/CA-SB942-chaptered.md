# SB 942 (2024, Ch. 291) California AI Transparency Act — Chaptered Text

> 来源：https://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=202320240SB942
> 提取日期：2026-08-08｜版本：CHAPTERED（2024-09-19签署）
> 注意：本文件为SB 942原始签署版。现行有效文本须与AB 853合并阅读（AB853修订处从其为准）。
...
(h) “Personal provenance data” means provenance data
...
(1) Information
 regarding the type of device, system, or service that was used to generate a piece of digital content.
...
(3) The tool does not output any personal provenance data that is
...
(3) The disclosure is permanent or extraordinarily difficult to remove, to the extent it is
...
(c) (1) If a covered provider licenses its GenAI system to a third
...
(3) A third-party licensee shall cease using a licensed GenAI system after the license for the system has
...
(c) For a violation by a
 third-party licensee of paragraph (3) of subdivision (c) of Section 22757.3, the Attorney General, a county counsel, or a city attorney may bring a civil action for both of the following:
(1) Injunctive relief.
