# AB 853 (2025, Ch. 674) — Chaptered Text（SB 942修正案）

> 来源：https://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=202520260AB853
> 提取日期：2026-08-08｜版本：CHAPTERED（2025-10-13签署）
> 注意：本文件为修正案，非清洁版。修订/新增条款覆盖SB 942对应内容；SB 942未被触及的条款继续有效。
...
This bill would, beginning January 1, 2027,
...
This bill would, beginning January 1, 2027, prohibit a GenAI system hosting platform, as defined, from knowingly making available a GenAI system that does not place disclosures, pursuant to those
 provisions.
...
SEC. 2.
 Section 22757.3.1 is added to the Business and Professions Code, to read:
22757.3.1.
 (a) A large online platform shall do all of the following:
(1) Detect whether any provenance data that is compliant with widely adopted specifications adopted by an established
...
(ii) The name of the GenAI system or capture device that created or substantially altered the content, if
 applicable.
...
SEC. 3.
 Section 22757.3.2 is added to the Business and Professions Code, to read:
22757.3.2.
...
SEC. 4.
 Section 22757.3.3 is added to the Business and Professions Code, to read:
22757.3.3.
 (a) A capture device manufacturer shall, with respect to any capture device the capture device manufacturer first produced for sale in the state on or after January 1, 2028, do both of the
 following:
...
SEC. 6.
 Section 22757.6 of the Business and Professions Code is amended to read:
22757.6.
